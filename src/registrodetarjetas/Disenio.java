...
public class Disenio extends javax.swing.JFrame {
    ...
    private void BotonIngresarArchivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonIngresarArchivoActionPerformed
        String direccion=JOptionPane.showInputDialog("Ingrese la direccion de su archivo: ", "C:\\Users\\Usuario\\Downloads\\drive-download-20220426T231430Z-001\\calificacion.txt");
        ArchivoDeEntrada archivoEntrada= new ArchivoDeEntrada(this);
